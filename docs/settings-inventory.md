...
| `Мастер первого запуска` | 1-1544 (1544) | 5 | 6 |
...
Строки 449-1050 в `qml/windows/Settings.qml`.
...
Строки 1053-1225 в `qml/windows/Settings.qml`.
...
Строки 1228-1553 в `qml/windows/Settings.qml`.
...
Строки 1565-1886 в `qml/windows/Settings.qml`.
...
Строки 1903-2645 в `qml/windows/Settings.qml`.
...
Строки 2654-3044 в `qml/windows/Settings.qml`.
...
Строки 3049-3397 в `qml/windows/Settings.qml`.
...
Строки 3400-3655 в `qml/windows/Settings.qml`.
...
Строки 1-1544 в `qml/windows/Onboarding.qml`.
