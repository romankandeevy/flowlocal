...
//
// Живёт отдельным файлом, потому что мест уже три - шапка главного окна,
// боковая панель настроек и «О программе», - и они обязаны совпадать: вордмарк,
// нарисованный трижды на глаз, расходится на первой же правке.
