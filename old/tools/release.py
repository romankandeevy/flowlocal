...
Способ доставки ровно один - установщик из этого релиза. Канал npm
(`npx @usekorti/flowlocal`) убран решением владельца: он жил для разработчиков,
а разработчик скачает установщик со страницы релизов одним нажатием - тогда как
`npx` требует сперва поставить Node.js. Канал не убирал шаг, а добавлял, и при
этом молча отставал на четыре выпуска. Разбор целиком - в HANDOFF.md; заводить
его заново не надо.
