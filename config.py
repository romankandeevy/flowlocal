...
DEFAULTS: dict = {
    ...
    #   "medium" - плюс чистка от бубнежа (умолчание);
    ...
    "cleanup": "medium",
    # Что открывать в заметках при запуске окна:
    #   "last" - ту, что писали в прошлый раз (умолчание);
    #   "new"  - каждый раз чистый лист.
    # Второе для тех, у кого заметка - это разовая мысль, а не дневник.
