...
| `settings_qt.py`, `qml/windows/Settings.qml` | окно программы: как дела, история, статистика и настройки. Данные в Python, вёрстка в QML |
| `notes.py` | заметки: хранение, поиск, уборка. Показывает их страница «Заметки» в окне программы |
...
- Поверх игры в полноэкранном эксклюзивном режиме пилюли не видно, и вставка
  ...
  в буфер»: текст сразу ложится в буфер обмена, и никуда не вставляется.
