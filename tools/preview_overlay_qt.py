...
def main() -> None:
    ...
    script = [
        ...
        # Живой счётчик слов: разбор на ходу отдаёт его по мере речи. Без этой
        # строки контактный лист показывал запись без счётчика - то есть врал
        # про то, как пилюля выглядит на настоящей диктовке.
        (3.2, lambda: ov.set_words(9)),
        (4.2, lambda: ov.set_words(23)),
